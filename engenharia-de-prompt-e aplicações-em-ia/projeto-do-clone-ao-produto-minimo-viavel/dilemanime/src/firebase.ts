...
// Analytics and Remote Config (Optional/Safe initialization)
...
export { signInWithPopup, signOut, onAuthStateChanged, collection, doc, setDoc, getDoc, getDocs, query, where, deleteDoc, onSnapshot };
export type { User };
