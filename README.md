# Marcelo Fagundes de Oliveira Vieira
> Estudante de Análise de Desenvolvimento de Sistemas
 
---
 
### 📫 Contato & Redes Sociais
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://br.linkedin.com/in/marcelo-fagundes-de-oliveira-vieira-aa8b83388?utm_source=share&utm_medium=member_mweb&utm_campaign=share_via&utm_content=profile)
[![E-mail](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:marcelofdov@gmail.com)
...
### 👨‍💻 Sobre
Atualmente cursando o 2º período de Análise de Desenvolvimento de Sistemas  na Unicid. Sou focado em aprender a resolver problemas através da tecnologia e possuo foco em Análise de Dados e Linguagem Python.
 
* **Habilidades Técnicas:** Python, SQL, C, HTML, CSS].
...
| **Mini mundo** | Criação de Diagramas Entidade-Relacionamento (DER) e mapeamento lógico para cenários de negócios reduzidos. | [Ver Projeto](https://github.com/marcelofg7/portfolio-marcelo-fagundes-de-oliveira-vieira/tree/main/modelagem-de-banco-de-dados/mini-mundo) |
 
#### 🤖 Inteligência Artificial & Engenharia de Prompt
| Projeto | Descrição | Link |
| :--- | :--- | :---: |
| **A Corrida do Prompt** | Técnicas avançadas de escrita de instruções para otimizar resultados em LLMs. | [Ver Projeto](https://github.com/marcelofg7/portfolio-marcelo-fagundes-de-oliveira-vieira/tree/main/engenharia-de-prompt-e%20aplica%C3%A7%C3%B5es-em-ia/projeto-a-corrida-do-prompt) |
| **Batalha de Modelos & XML** | Comparação de performance entre modelos utilizando estruturação de dados em XML. | [Ver Projeto](https://github.com/marcelofg7/portfolio-marcelo-fagundes-de-oliveira-vieira/tree/main/engenharia-de-prompt-e%20aplica%C3%A7%C3%B5es-em-ia/projeto-batalha-de-modelos-%26-engenharia-de-prompt-(xml)) |
